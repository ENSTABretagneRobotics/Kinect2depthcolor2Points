cd /d "%~dp0"
"C:\Program Files (x86)\IrfanView\i_view32.exe" %1 /hflip /convert=%1
rem "C:\Program Files (x86)\IrfanView\i_view32.exe" %1 /hflip /convert=%~pn1_hflip%~x1
...
"C:\Program Files (x86)\IrfanView\i_view32.exe" %1 /hflip /convert=%~pn1_hflip%~x1
